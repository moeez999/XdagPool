          ...
          <tbody>
            {filteredWorkers.map((w, i) => (
              <tr key={i} className=" hover:bg-gray-700 transition-colors">
                ...
                <td className="border  text-white  border-gray-600 px-4 py-2 capitalize">
                  {w.status}
                </td>
                <td className="border  text-white  border-gray-600 px-4 py-2 text-right">
                  {Number(w.unpaidShares).toFixed(1)}
                </td>
                <td className="border  text-white  border-gray-600 px-4 py-2 text-right">
                  {Number(w.hashrate).toFixed(1)}
                </td>
                <td className="border  text-white  border-gray-600 px-4 py-2 text-center">
